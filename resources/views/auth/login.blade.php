            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-offset-2">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('auth_oauth_provider', ['provider' => $oauth->getProviderName()]) }}">
                        {!! csrf_field() !!}
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-btn fa-sign-in"></i>{{ $oauth->getFormLabel() }}
                        </form>
                    </div>
                </div>
            </div>
